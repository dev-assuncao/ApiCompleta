...
namespace DevIO.Api.Controllers
{
    ...
    public class FornecedoresController : MainController
    {
        ...
        public async Task<ActionResult<FornecedorViewModel>> Atualizar(Guid id, FornecedorViewModel fornecedorViewModel)
        {
            ...
            {
                NotificarErro(message: "O id informado é diferente do que foi passado na query");
        ...
        public async Task<ActionResult<EnderecoViewModel>> AtualizarEndereco(Guid id, EnderecoViewModel enderecoViewModel)
        {
            ...
            {
                NotificarErro(message: "O id informado não é o mesmo que foi passado na query");
